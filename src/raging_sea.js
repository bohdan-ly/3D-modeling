...
// Colors
debugObject.depthColor = '#1a88ff';
debugObject.surfaceColor = '#00ffd5';
...
gui
  .add(waterMaterial.uniforms.uBigWavesElevation, 'value', 0, 10, 0.001)
...
gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value', 0.01, 4, 0.001).name('uBigWavesSpeed');
gui
...
gui.add(waterMaterial.uniforms.uColorOffset, 'value', 0.01, 1, 0.001).name('uColorOffset');
