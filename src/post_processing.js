...
gui.add(tintPass.material.uniforms.uTint.value, 'x', -1, 1, 0.001).name('red color');
gui.add(tintPass.material.uniforms.uTint.value, 'y', -1, 1, 0.001).name('green color');
gui.add(tintPass.material.uniforms.uTint.value, 'z', -1, 1, 0.001).name('blue color');
